...
namespace GameServer.Controller
{
    class RoomController:BaseController
    {
        ...
        public string JoinRoom(string data, Client client, Server server)
        {
         ...
         Room room= server.GetRoomById(id);
            ...
            else
            {
                ...
                string roomData = room.GetRoomData();//id:username:total:win|id:username:total:win
        ...
        public string ListRoom(string data, Client client, Server server)
        {
            ...
            {
                sb.Append("0");
                return ((int)ReturnCode.Fail).ToString() + "," + sb;
            }
            else
            {
                sb.Remove(sb.Length - 1,1);
                return ((int)ReturnCode.Success).ToString() + "," + sb;
            }
